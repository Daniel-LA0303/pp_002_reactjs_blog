 ...
 * redux
 */
import { fecthGetOneBlogPage, resetError } from '../store/blogSlice'
 ...
 * components
 */
import CommentBlog from '../.modules/comments/components/CommentBlog'
import AuthorBlogCard from '../../user/components/AuthorBlogCard'
                    ...
                    <main className="w-full">
                        {
                            ...
                            <div className="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" style={{ height: '20em' }}>
                                ...
                                <img
                                    src={`${blog?.blogImage && blog.blogImage}`}
                            ...
                            <div>
                                <div className="flex mt-3">
                                    <Link to={`/profile/${blog?.userInfo.userId}`}>
                                        <img
                                            src={`${blog?.userInfo?.profilePicture ? blog?.userInfo?.profilePicture : '/avatar.png'} `}
