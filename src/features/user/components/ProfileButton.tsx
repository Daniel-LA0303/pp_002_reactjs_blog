...
const ProfileButton = () => {
  ...
  // to show image profile or show avatar.png
  ...
  return (
    <div className="relative hover:bg-slate-100 rounded-full" ref={menuRef}>
      {/* Botón del perfil */}

      <img
        alt="User Avatar"
        src={validImage ? profileImage : "/avatar.png"}
        className="relative inline-block h-10 w-10 cursor-pointer rounded-full object-cover"
        onClick={toggleMenu}
      />
      ...
      <ul
        ...
        className={`
          absolute right-1 top-14 z-10
          flex min-w-[180px] flex-col gap-2
          overflow-auto rounded-md border border-blue-gray-50
          bg-white p-3 font-sans text-sm font-normal
          text-blue-gray-500 shadow-lg shadow-blue-gray-500/10
          focus:outline-none
      ...
      >
        ...
        <Link
          to={`/chat`}
          role="menuitem"
          className="flex md:hidden w-full cursor-pointer select-none items-center gap-2 rounded-md px-3 pt-[9px] pb-2 text-start leading-tight outline-none transition-all hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900 hover:bg-gray-600 hover:text-white"
        >
