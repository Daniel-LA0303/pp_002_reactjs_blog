  ...
  const fetchBlogs = async () => {
    ...
    try {
      const response = await apiAuthClient.get(
        `/blog/dashboard?userId=${userIdNumber}&type=BLOGS_LIKED&page=${page}&size=10`
      );
            ...
            {blogs.length !== 0 ? (
              ...
              <div className="flex flex-col justify-center items-center">
                <p className="text-center text-2xl mt-10">
                  You do not have blogs to read later o saved yet
                </p>
              </div>
            ) : null}
...
export default BlogsByLikeDashboard