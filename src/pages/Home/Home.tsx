        ...
        <div className="w-full max-w-screen-lg px-2  lg:mx-auto flex flex-wrap gap-4">
          ...
          <div className="hidden lg:block lg:w-3/12">
            ...
            <div className="pl-4">
              ...
              <div className="flex flex-col max-w-sm px-6 pt-4 mx-auto bg-white rounded-lg shadow-md">
                <ul className="-mx-4">
                  {homePageInfo?.usersTop.map(user => (
                    <li key={user.userId} className="flex mb-4 ">
                      <div>
                      ...
                      <div className='flex justify-between items-center w-full'>
                        <p>
                          <Link
                            ...
                            className="mx-1 font-semibold text-sm text-gray-700 hover:underline"
                          >
                            {user.name}
                          </Link>
                        </p>
                        <span className="mx-1 text-xs font-light text-gray-700">
                          Created {user.blogsCounts} Blogs
                        </span>
                      </div>
                    </li>
                  ))}
            ...
            <div className="pl-4 mt-10">
              ...
              <div className="flex flex-col max-w-sm px-3 pt-2 mx-auto bg-white rounded-lg shadow-md">
                <ul>
                  {homePageInfo.categoriesTop.map(category => (
                    <li key={category.categoryId}>
                      <Link
                        to={`/categoy-by-blog/${category.name}`}
                        className="mx-1 mb-2 text-gray-700 hover:text-gray-600  flex hover:underline"
